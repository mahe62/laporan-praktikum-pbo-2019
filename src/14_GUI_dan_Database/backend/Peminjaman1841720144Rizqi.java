 ...
 * @author mwpras
 */
public class Peminjaman1841720144Rizqi {
    private int idpeminjaman;
    private Anggota1841720144Rizqi anggota = new Anggota1841720144Rizqi();
    private Buku1841720144Rizqi buku = new Buku1841720144Rizqi();
    private String tanggalpinjam;
    private String tanggalkembali;

    public Peminjaman1841720144Rizqi() {
    }

    public Peminjaman1841720144Rizqi(Anggota1841720144Rizqi anggota, Buku1841720144Rizqi buku, String tanggalpinjam, String tanggalkembali) {        
    ...
    public Anggota1841720144Rizqi getAnggota() {
        return anggota;
    }

    public void setAnggota(Anggota1841720144Rizqi anggota) {
        this.anggota = anggota;
    }

    public Buku1841720144Rizqi getBuku() {
        return buku;
    }

    public void setBuku(Buku1841720144Rizqi buku) {
        this.buku = buku;
    }
    ...
    public Peminjaman1841720144Rizqi getById(int id){
        Peminjaman1841720144Rizqi peminjaman = new Peminjaman1841720144Rizqi();
        ResultSet rs = DBHelper1841720144Rizqi.selectQuery("SELECT "
        ...
        try {
            while(rs.next()){
                peminjaman = new Peminjaman1841720144Rizqi();
    ...
    public ArrayList<Peminjaman1841720144Rizqi> getAll(){
        ArrayList<Peminjaman1841720144Rizqi> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720144Rizqi.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
                                        +"      p.tanggalkembali AS tanggalkembali, "
    ...
    public ArrayList<Peminjaman1841720144Rizqi> search(String keyword){
        ArrayList<Peminjaman1841720144Rizqi> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720144Rizqi.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
    ...
    public void save(){
        if(getById(idpeminjaman).getIdpeminjaman()== 0){
            String SQL = "INSERT INTO peminjaman (idanggota, idbuku, tanggalpinjam, tanggalkembali) VALUES("
                    ...
                    +"      '"+ this.tanggalkembali + "' "
                    +"      )";
            this.idpeminjaman = DBHelper1841720144Rizqi.insertQueryGetId(SQL);
