 ...
 * @author ASUS
 */
public class KeretaApi21841720144Rizqi {
    ...
    public KeretaApi21841720144Rizqi(String mNama, String mKelas, Pegawai1841720144Rizqi mMasinis, Pegawai1841720144Rizqi mAsisten) {
        this.mNama = mNama;
        this.mKelas = mKelas;
    ...
    public KeretaApi21841720144Rizqi(String mNama, String mKelas, Pegawai1841720144Rizqi mMasinis) {
        this.mNama = mNama;
        this.mKelas = mKelas;
        this.mMasinis = mMasinis;
    }

    public KeretaApi21841720144Rizqi() {
    }
